...
YOUTUBE_DATA_API_CREDENTIALS_LOCATION = 'client_secrets.json'
...
def create_thumbnail(biden_vote_count, trump_vote_count):
    ...
    print("Successfully generated the image and saved to trump_biden_generated.png")
